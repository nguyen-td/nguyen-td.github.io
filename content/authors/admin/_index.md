...
Before I joined the PhD program, I completed my master's in Computational Neuroscience at the [Bernstein Center for Computational Neuroscience Berlin](https://www.bccn-berlin.de/), where I worked with [Prof. Stefan Haufe](https://www.tu.berlin/uniml/about/head-of-group) on computational methods to analyze linear and nonlinear functional connectivity from EEG time series. Before that, I did my bachelor's in Computer Science & Economics (Wirtschaftsinformatik) at the [Berlin School of Economics and Law](https://www.hwr-berlin.de/en/), where I worked at [Berliner Wasserbetriebe](https://languages.bwb.de/en/index.php) as part of their dual studies program. 